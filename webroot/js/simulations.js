function simulation(type) {
    ...
    searchCitys = function() {
        $.ajax({
            url: "/api/web/simulation/search-citys",
        ...
        $.ajax({
            url: "/api/web/simulation/search-abertura",
            data: $("#simulation-abertura").serialize(),
            type: "POST",
            dataType: "json",
            beforeSend: function() {},
        ...
        $("#abertura-estado").change(function() {
            ...
            "real" === $(this).data("type") ? ($("#result-mensalidade").html("Sob consulta"), $("#alert_lucro_real").modal('show'), $("#text-month").css("visibility", "hidden")) : (simulation($(this).data("type") + "_" + $("#form-type").val()), $("#area-simulation").css("display", "block"), $("#area-lucro-real").css("display", "none"));
    ...
    function simulationDigital(type) {
        ...
        $(function() {
            ...
            $("#form-custo, #form-software").bind("keyup", function(o) {
                ...
                "mei" === $(this).val() || "liberal" === $(this).val() || "empregado" === $(this).val() || "inativa" === $(this).val() ? ($("#form-socios-digital").css("display", "none"), $("#text-socios").css("display", "none"), $("#form-funcionarios-digital").css("display", "block"), $("#text-funcionarios").css("display", "block"), $("#form-funcionarios-digital").val("0"), $("#form-funcionarios-digital").attr("max", "1"), "mei" === $(this).val() || "empregado" === $(this).val() ? ($(".type.digital").css("display", "none"), $("#form-funcionarios-digital").css("display", "none"), $("#text-funcionarios").css("display", "none"), $("#form-funcionarios-digital").val("0"), $("#text-faturamento-5k").css("display", "block"), $("#form-faturamento-digital").css("display", "none"), $("#form-faturamento-digital").val("1"), simulationDigital($(this).val())) : ($(".type.digital").css("display", "none"), $("#text-faturamento-5k").css("display", "none"), $("#form-faturamento-digital").css("display", "block"), simulationDigital($(this).val())), "mei" === $(this).val() && ($("#form-funcionarios-digital").css("display", "block"), $("#text-funcionarios").css("display", "block"), $("#form-funcionarios-digital").attr("max", "1")), "liberal" === $(this).val() && ($("#form-funcionarios-digital").css("display", "block"), $("#text-funcionarios").css("display", "block"), $("#form-funcionarios-digital").attr("max", "999"))) : ($("#text-socios").css("display", "block"), $("#form-socios-digital").css("display", "block"), $("#text-funcionarios").css("display", "block"), $("#form-funcionarios-digital").css("display", "block"), $("#form-funcionarios-digital").val("0"), $("#form-funcionarios-digital").attr("max", "999"), $(".type.digital").css("display", "block"), $("#text-faturamento-5k").css("display", "none"), $("#form-faturamento-digital").css("display", "block"), simulationDigital("simples_" + $(this).val()))
                if("real" === $(".simulation-digital .box-simulation-digital .active").data("type")) { ($("#result-mensalidade-digital").html("Sob consulta"), $("#text-month").css("visibility", "hidden")) }
...
"mei" === $(this).val() || "liberal" === $(this).val() || "empregado" === $(this).val() || "inativa" === $(this).val() ? ($("#form-socios-digital").css("display", "none"), $("#text-socios").css("display", "none"), $("#form-funcionarios-digital").css("display", "block"), $("#text-funcionarios").css("display", "block"), $("#form-funcionarios-digital").val("0"), $("#form-funcionarios-digital").attr("max", "1"), "mei" === $(this).val() || "empregado" === $(this).val() ? ($(".type").css("display", "none"), $("#form-funcionarios-digital").css("display", "none"), $("#text-funcionarios").css("display", "none"), $("#form-funcionarios-digital").val("0"), $("#text-faturamento-5k").css("display", "block"), $("#form-faturamento-digital").css("display", "none"), $("#form-faturamento-digital").val("1"), simulationDigital($(this).val())) : ($(".type").css("display", "none"), $("#text-faturamento-5k").css("display", "none"), $("#form-faturamento-digital").css("display", "block"), simulationDigital($(this).val())), "mei" === $(this).val() && ($("#form-funcionarios-digital").css("display", "block"), $("#text-funcionarios").css("display", "block"), $("#form-funcionarios-digital").attr("max", "1")), "liberal" === $(this).val() && ($("#form-funcionarios-digital").css("display", "block"), $("#text-funcionarios").css("display", "block"), $("#form-funcionarios-digital").attr("max", "999"))) : ($("#text-socios").css("display", "block"), $("#form-socios-digital").css("display", "block"), $("#text-funcionarios").css("display", "block"), $("#form-funcionarios-digital").css("display", "block"), $("#form-funcionarios-digital").val("0"), $("#form-funcionarios-digital").attr("max", "999"), $(".type").css("display", "block"), $("#text-faturamento-5k").css("display", "none"), $("#form-faturamento-digital").css("display", "block"), simulationDigital("simples_" + $(this).val()))
