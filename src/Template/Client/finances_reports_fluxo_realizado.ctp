...
<!-- Menu Page -->
<div class="menu-page">
    <span class="title-page">Fluxo de caixa Realizado</span>
</div>
            ...
            <div style="padding: 20px; padding-top: 20px; padding-bottom: 0px; margin-top: 0px; border-radius: 8px;">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 animate-scroll text-right">
                        ...
                        <form action="/client/finances/reports/fluxo-realizado" method="POST" id="form-update-report-review-1">
                            ...
                            <select type="text" class="form-control margin-r-10" name="report_type"  style="font-size: 14px; background-color: #fff; width: auto; display: inline-block;" id="input-filter-report-type" onchange="location = this.value;">
                                ...
                                <option value="/client/finances/reports/fluxo-realizado" selected>Fluxo de caixa Realizado</option>
                                <option value="/client/finances/reports/fluxo-previsto-realizado">Fluxo de caixa Previsto x Realizado</option>
                            </select>
                ...
                <table class="table table-responsive" style="height: 510px;">
                    ...
                    <?php 
                        for ($x=0; $x < count($model_report_dre); $x++) {
                            ...
                            if($model_report_dre[$x] == 'Receitas de Vendas e de Serviços'){ $color_bg = 'FFF8E3'; }
                            if($model_report_dre[$x] == 'Saldo Inicial'){ $color_bg = 'FFF8E3'; }
                            if($model_report_dre[$x] == 'Despesas com Salários e Encargos'){ $color_bg = 'FFF8E3'; }
                            if($model_report_dre[$x] == 'Geração de Caixa do Período'){ $color_bg = 'FFF8E3'; }
                            if($model_report_dre[$x] == 'Total de Transferências'){ $color_bg = 'FFF8E3'; }
                            if($model_report_dre[$x] == 'Saldo Final de Caixa'){ $color_bg = 'FFF8E3'; }
                    ?>
