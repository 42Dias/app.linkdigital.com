...
<div class="row">
    ...
    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-xs-12 margin-mobile-b-30" style="padding-left: 0px;">
        <span class="title-page">Notas fiscais</span>
    </div>
    ...
    <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-xs-12 margin-mobile-b-30" style="padding-left: 0px;">
        ...
        <select type="text" class="form-control margin-r-10" name="report_type"  style=" float: right; font-size: 12px; background-color: #fff; width: auto; display: inline-block; height: 45px !important;">
            <option value="/client/nf">Hoje</option>    
            <option value="/client/nf">Últimos 3 dias</option>
            <option value="/client/nf">Últimos 7 dias</option>
            <option value="/client/nf">Últimos 15 dias</option>
            <option value="/client/nf">Últimos 30 dias</option>
        </select>
            ...
            <div style="padding: 20px; padding-top: 20px; padding-bottom: 60px; margin-top: 0px; border-radius: 8px;">
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 animate-scroll">
                        ...
                        <div class="box-tabs" style="margin-top: 0px;">
                            <a href="/client/nf?tab_select=all" class="tab-item <?php if($tab_select == '' || $tab_select == 'all'){ echo 'active'; } ?>" data-open="#tab-content-nfse">Todos</a>
                            <a href="/client/nf?tab_select=nfse" class="tab-item <?php if($tab_select == 'nfse'){ echo 'active'; } ?>" data-open="#tab-content-nfse">NFS-e</a>
                            <a href="/client/nf?tab_select=nfe" class="tab-item <?php if($tab_select == 'nfe'){ echo 'active'; } ?>" data-open="#tab-content-nfe">NF-e</a>
                            <a href="/client/nf?tab_select=nfce" class="tab-item <?php if($tab_select == 'nfce'){ echo 'active'; } ?>" data-open="#tab-content-nfce">NFC-e</a>
                            <div class="clear"></div>
                        </div>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 text-right animate-scroll">
                        ...
                        <div class="btn btn-yellow size-sm" data-toggle="modal" data-target="#add_nf">
                                EMITIR NOTA FISCAL
                        </div>
                    </div>
                </div>
                ...
                <div class="row margin-t-40" style="background-color: #efefef; padding: 10px; border-radius: 10px;">
                    <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12 animate-scroll">
                        <p class="text" style="margin-bottom: 0px; color: #666; font-weight: 600;">Tomador</p>
                    </div>
                    ...
                    <div class="col-xl-1 col-lg-1 col-md-1 col-sm-12 col-xs-12 animate-scroll">
                        <p class="text" style="margin-bottom: 0px; color: #666; font-weight: 600;">Tipo</p>
                    </div>
                ...
                <?php $x=0; foreach ($query_nf as $nf) { $x++; ?>
                
                    <div class="row margin-t-20" style="padding: 0px 10px; position: relative;">
                        <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12 animate-scroll">
                            <strong style="color: #333; font-size: 12px;"><?php echo $nf->client; ?>Willian Half</strong>
                        </div>

                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12 animate-scroll">
                            <strong style="color: #333; font-size: 12px;"><?php echo $nf->description; ?></strong>
                        </div>

                        <div class="col-xl-1 col-lg-1 col-md-1 col-sm-12 col-xs-12 animate-scroll">
                            <strong style="color: #333; font-size: 12px;"><?php echo $nf->type; ?></strong>
                        </div>

                        <div class="col-xl-1 col-lg-1 col-md-1 col-sm-12 col-xs-12 animate-scroll">
                            <strong style="color: #333; font-size: 12px;"><?php echo date_format($nf->maturity, 'd/m/Y'); ?></strong>
                        </div>

                        <div class="col-xl-1 col-lg-1 col-md-1 col-sm-12 col-xs-12 animate-scroll">
                            <strong style="color: #333; font-size: 12px;">R$ <?php echo number_format($nf->amount, 2, ',', '.'); ?></strong>
                        </div>
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12 animate-scroll">
                            ...
                            <?php if($nf->status == 1){ ?> 
                                ...
                                <div class="badge-status relative default">Em processamento</div>

                            <?php } ?>
                            <?php if($nf->status == 2){ ?>

                                <div class="badge-status relative positive">Rejeitado</div>

                            <?php } ?>
                            <?php if($nf->status == 3){ ?>

                                <div class="badge-status relative positive">Emitido</div>
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12 animate-scroll">
                            ...
                            <?php if($nf->status == 3){ ?>
                                ...
                                <div class="btn btn-line-gray size-sm " style=" margin-left: 0px; padding: 10px 10px;" data-url="" data-form="" data-redirect="none"> 
                                    Download
                                </div>
                                
                                <div class="btn btn-line-gray size-sm " style="margin-left: 5px; padding: 10px 10px;" data-url="" data-form="" data-redirect="none"> 
                                    Cancelar
                                </div>
                ...
                <?php if($x == 0){ ?>
                    ...
                    <div class="text-center" style="margin-top: 70px; padding-bottom: 50px;">
                        <span class="title" style="font-size: 12px;">Você não possui nenhuma nota fiscal.</span>
                    </div>
