...
<!-- Menu Page -->
<div class="menu-page">
  <span class="title-page">Extratos bancários/Conta corrente/Aplicações financeiras</span>
</div>
...
<div class="area-actions" style="padding-top: 0px;">
    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 margin-mobile-b-30" style="padding-left: 0px;">
            ...
            <div class="box-file add client btn-add-extract" data-toggle="modal" data-target="#add_extract_client">
                <i class="material-icons-outlined">add</i>
                <span class="date"></span>
                <span class="title" style="color: #999;">Adicionar <br>extrato bancário</span>
            </div>
    ...
    <div class="row margin-t-40" style="background-color: #efefef; padding: 10px; border-radius: 10px;">
        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12 animate-scroll">
            <p class="text" style="margin-bottom: 0px; color: #666; font-weight: 600;">Nome do banco</p>
        </div>
        ...
        <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12 animate-scroll">
            <p class="text" style="margin-bottom: 0px; color: #666; font-weight: 600;">Início</p>
        </div>

        <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12 animate-scroll">
            <p class="text" style="margin-bottom: 0px; color: #666; font-weight: 600;">Término</p>
        </div>
    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 margin-mobile-b-30" style="padding-left: 0px;">
            ...
            <?php $x=0; foreach ($all_extracts as $extracts) { $x++; ?>
                ...
                <?php
                    if(date_format($extracts->date_inicial, 'm') == "01"){ $extract_month = "Janeiro"; }
                    if(date_format($extracts->date_inicial, 'm') == "02"){ $extract_month = "Fevereiro"; }
                    if(date_format($extracts->date_inicial, 'm') == "03"){ $extract_month = "Março"; }
                    if(date_format($extracts->date_inicial, 'm') == "04"){ $extract_month = "Abril"; }
                    if(date_format($extracts->date_inicial, 'm') == "05"){ $extract_month = "Maio"; }
                    if(date_format($extracts->date_inicial, 'm') == "06"){ $extract_month = "Junho"; }
                    if(date_format($extracts->date_inicial, 'm') == "07"){ $extract_month = "Julho"; }
                    if(date_format($extracts->date_inicial, 'm') == "08"){ $extract_month = "Agosto"; }
                    if(date_format($extracts->date_inicial, 'm') == "09"){ $extract_month = "Setembro"; }
                    if(date_format($extracts->date_inicial, 'm') == "10"){ $extract_month = "Outubro"; }
                    if(date_format($extracts->date_inicial, 'm') == "11"){ $extract_month = "Novembro"; }
                    if(date_format($extracts->date_inicial, 'm') == "12"){ $extract_month = "Dezembro"; }
                ?>

                <div class="box-file client btn-open-extracts" data-id="<?= $extracts->id; ?>" style="padding-left: 30px;">
                    <!-- <i class="material-icons-outlined">description</i> -->
                    
                    <div class="row">
                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12 animate-scroll">
                            <span class="date"><?php echo $extracts->bank; ?></span>
                        </div>

                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12 animate-scroll">
                            <span class="date"><?php echo $extracts->description; ?></span>
                        </div>

                        <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12 animate-scroll">
                            <span class="title"><?= date_format($extracts->date_inicial, 'd/m/Y'); ?></span>
                        </div>
            ...
            <?php if($x == 0){ ?>
                ...
                <!-- <div class="box-white size-xs">
                    ...
                    <div class="text-center" style="margin-top: 40px; padding-bottom: 50px;">
                        ...
                        <span class="title">Você não possui nenhuma nota fiscal.</span>
                    </div>
                </div> -->
