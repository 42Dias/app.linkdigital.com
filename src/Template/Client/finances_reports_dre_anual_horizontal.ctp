...
<!-- Menu Page -->
<div class="menu-page">
    <span class="title-page">DRE Anual Horizontal</span>
</div>
            ...
            <div style="padding: 20px; padding-top: 20px; padding-bottom: 0px; margin-top: 0px; border-radius: 8px;">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 animate-scroll text-right">
                        ...
                        <form action="/client/finances/reports/dre-anual-horizontal" method="POST" id="form-update-report-review-1">
                            ...
                            <select type="text" class="form-control margin-r-10" name="report_type"  style="font-size: 14px; background-color: #fff; width: auto; display: inline-block;" id="input-filter-report-type" onchange="location = this.value;">
                                <option value="/client/finances/reports/dre-anual-horizontal" selected>DRE Anual Horizontal</option>
                                ...
                                <option value="/client/finances/reports/dre-mensal-vertical">DRE Mensal Vertical</option>
                            </select>
                ...
                <table class="table table-responsive" style="height: 510px;">
                    <tr class='fixed-row' style="background-color: #efefef; padding: 10px; border-radius: 10px;">
                        ...
                        <td><p class="text" style="margin-bottom: 0px; color: #666; font-weight: 600; font-size: 12px;">2018</p></td>
                        <td><p class="text" style="margin-bottom: 0px; color: #666; font-weight: 600; font-size: 12px;">AH%</p></td>
                        <td><p class="text" style="margin-bottom: 0px; color: #666; font-weight: 600; font-size: 12px;">2019</p></td>
                        <td><p class="text" style="margin-bottom: 0px; color: #666; font-weight: 600; font-size: 12px;">AH%</p></td>
                        <td><p class="text" style="margin-bottom: 0px; color: #666; font-weight: 600; font-size: 12px;">2020</p></td>
                        <td><p class="text" style="margin-bottom: 0px; color: #666; font-weight: 600; font-size: 12px;">AH%</p></td>
                        <td><p class="text" style="margin-bottom: 0px; color: #666; font-weight: 600; font-size: 12px;">2021</p></td>
                        <td><p class="text" style="margin-bottom: 0px; color: #666; font-weight: 600; font-size: 12px;">AH%</p></td>
                        <td><p class="text" style="margin-bottom: 0px; color: #666; font-weight: 600; font-size: 12px;">Total</p></td>
                    </tr>
