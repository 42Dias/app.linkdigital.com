...
<!-- Menu Page -->
<div class="menu-page">
  <span class="title-page">Faturas</span>
</div>
    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 margin-mobile-b-30" style="padding-left: 0px;">
            ...
            <?php $x=0; foreach ($all_invoices as $invoice) { $x++; ?>
                ...
                <a href="<?= $invoice->billet_link; ?>" target="_blank" class="box-file client btn-open-invoice" data-id="<?= $invoice->id; ?>" style="padding-left: 30px; text-decoration: none;">
                    <!-- <i class="material-icons-outlined">description</i> -->
                    
                    <div class="row">
                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12 animate-scroll">
                            <span class="date"><?php echo 'Fatura #'.$invoice->id; ?></span>
                        </div>
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12 animate-scroll">
                            <span class="title">R$ <?php echo $invoice->amount; ?></span>
                        </div>

                        <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12 animate-scroll">
                            <span class="title"><?= date_format($invoice->maturity, 'd/m/Y'); ?></span>
                        </div>
            ...
            <?php if($x == 0){ ?>
                ...
                <div class="box-white size-xs">
                    ...
                    <div class="text-center" style="margin-top: 40px; padding-bottom: 50px;">
                        ...
                        <span class="title">Você não possui nenhuma fatura a pagar.</span>
                    </div>
                </div>
