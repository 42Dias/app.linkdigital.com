...
<div class="area-actions" style="padding-top: 0px;">
    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 margin-mobile-b-30" style="padding-left: 0px;">
            ...
            <div class="box-file add client btn-add-note" data-toggle="modal" data-target="#add_note_client">
                <i class="material-icons-outlined">add</i>
                <span class="date"></span>
                <span class="title" style="color: #999;">Adicionar <br>nota fiscal</span>
            </div>
    ...
    <div class="row margin-t-40" style="background-color: #efefef; padding: 10px; border-radius: 10px;">
        ...
        <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12 animate-scroll">
            <p class="text" style="margin-bottom: 0px; color: #666; font-weight: 600;">Período</p>
        </div>
    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 margin-mobile-b-30" style="padding-left: 0px;">
            ...
            <?php $x=0; foreach ($all_notes as $notes) { $x++; ?>
                ...
                <div class="box-file client btn-open-notes" data-id="<?= $notes->id; ?>" style="padding-left: 30px;">
                    <!-- <i class="material-icons-outlined">description</i> -->
                    
                    <div class="row">
                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12 animate-scroll">
                            <span class="date"><?php echo $notes->title; ?></span>
                        </div>

                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12 animate-scroll">
                            <span class="date"><?php echo $notes->description; ?></span>
                        </div>

                        <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12 animate-scroll">
                            <span class="title">R$ <?php echo $notes->total; ?></span>
                        </div>

                        <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12 animate-scroll">
                            <span class="title"><?= $notes->date; ?></span>
                        </div>
