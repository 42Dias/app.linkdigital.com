...
<div class="row margin-t-40">
    ...
    <?php for ($total_business=1; $total_business < 6; $total_business++) { ?>

      <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12 margin-mobile-b-30" style="padding-left: 0px; background-color: #fffbec; padding: 20px; border-radius: 20px;">

        <h3 class="margin-t-0 margin-b-0" style="color: #333;">
            <strong>Etapa <?=$total_business?></strong>
        </h3>

        <span style="font-size: 12px; color: #858585; font-weight: 600;">
          
          <?php
            if($total_business == 1){ echo $total_step_1; }
            if($total_business == 2){ echo $total_step_2; }
            if($total_business == 3){ echo $total_step_3; }
            if($total_business == 4){ echo $total_step_4; }
            if($total_business == 5){ echo $total_step_5; }
          ?>
        ...
        <br><br>
          ...
          <?php $x=0; foreach ($all_business as $business) { $x++; ?>
            ...
            <?php if($business->steps == $total_business){ ?>
              ...
              <a href="/admin/business/<?= $business->id; ?>/view" class="box-white size-auto" style="display: block; margin-top: 5px; text-decoration: none; padding: 20px 30px;">
                  ...
                  <div class="row">
                      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          ...
                          <br>
                          <span style="font-size: 12px; color: #666; font-weight: 600;"><?php if($business->fantasia == ""){ echo $business->razao; }else{ echo $business->fantasia; } ?></span>
                      </div>

                      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <span style="font-size: 12px; color: #999; font-weight: 500;"><?= $taxation_text; ?></span>
                          <br>
                          <span style="font-size: 12px; color: #666; font-weight: 600;"><?= $type_text; ?></span>
                      </div>
                      ...
                      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          ...
                          <br>
                          <span style="font-size: 12px; color: #666; font-weight: 600;"><?php echo $business->city." - ".$business->state; ?></span>
                      </div>
                  </div>
    ...
    <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12 margin-mobile-b-30" style="padding-left: 0px; background-color: #fffbec; padding: 20px; border-radius: 20px;">
        ...
        <h3 class="margin-t-0 margin-b-10" style="color: #333;">
            <strong>Pago</strong>
        </h3>
