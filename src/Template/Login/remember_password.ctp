            ...
            <div class="column col-xl-5 col-lg-6 col-md-7 col-sm-12 col-xs-12" style="margin: 0 auto;">
                <div class="login-content">
                    ...
                    <div class="box-login" style="padding-top: 15%;">
                        ...
                        <span class="sub-title margin-t-5">Digite o endereço de e-mail abaixo:</span>
                        ...
                        <div style="margin-top: 70px;">
                            ...
                            <div class="margin-t-40">
                                <div class="form-group">
                                    <button id="send-password" class="btn btn-yellow btn-block size-lg">RECUPERAR SENHA</button>
                                </div>
                            </div>
                        </div>
