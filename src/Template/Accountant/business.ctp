    ...
    <div class="row margin-t-40">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 margin-mobile-b-30" style="padding-left: 0px;">
            ...
            <?php $x=0; foreach ($all_business as $business) { $x++; ?>
                ...
                <!-- Comercial visualiza todos -->
                <?php if($business->status > 1 || $permission_user == 13){ ?>

                    <a href="/accountant/business/<?= $business->id; ?>/view-infos" class="box-white size-auto" style="display: block; margin-top: 5px; text-decoration: none; padding: 20px 30px; padding-left: 90px;">
