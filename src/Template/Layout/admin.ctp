...
<body class="app">
    ...
    <div class="main-menu">
        ...
        <div class="box-title-itens">
            ...
            <a href="/admin" class="title-item <?php if($menu_active == "home"){ echo "active"; } ?>" data-item="default">
                <i class="material-icons-outlined">home</i> &nbsp;&nbsp; Visão Geral
            </a>

            <a href="/admin/business" class="title-item <?php if($menu_active == "business"){ echo "active"; } ?>" data-item="default">
                <i class="material-icons-outlined">work_outline</i> &nbsp;&nbsp; Empresas
            </a>

            <!-- <a href="/admin/tasks" class="title-item <?php if($menu_active == "tasks"){ echo "active"; } ?>" data-item="default">
                <i class="material-icons-outlined">bookmark_border</i> &nbsp;&nbsp; Obrigações
            </a> -->

            <a href="/admin/crm" class="title-item <?php if($menu_active == "crm"){ echo "active"; } ?>" data-item="default">
                <i class="material-icons-outlined">filter_list</i> &nbsp;&nbsp; CRM
            </a>

            <!-- <a href="/admin/invoices" class="title-item <?php if($menu_active == "invoices"){ echo "active"; } ?>" data-item="default">
                <i class="material-icons-outlined">description</i> &nbsp;&nbsp; Faturas
            </a> -->

            <a href="/admin/permissions" class="title-item <?php if($menu_active == "permissions"){ echo "active"; } ?>" data-item="default">
                <i class="material-icons-outlined">outlined_flag</i> &nbsp;&nbsp; Nível de Permissão
            </a>

            <a href="/admin/account" class="title-item <?php if($menu_active == "account"){ echo "active"; } ?>" data-item="default">
                <i class="material-icons-outlined">perm_identity</i> &nbsp;&nbsp; Minha conta
            </a>

            <a href="/admin/reports" class="title-item <?php if($menu_active == "reports"){ echo "active"; } ?>" data-item="default">
                <i class="material-icons-outlined">class</i> &nbsp;&nbsp; Relatórios
            </a>

            <a href="/admin/indicators" class="title-item <?php if($menu_active == "indicators"){ echo "active"; } ?>" data-item="default">
                <i class="material-icons-outlined">bookmark_border</i> &nbsp;&nbsp; Indicadores
            </a>

            <a href="/admin/support" class="title-item <?php if($menu_active == "support"){ echo "active"; } ?>" data-item="default">
        ...
        <a href="/admin" class="item <?php if($menu_active == "home"){ echo "active"; } ?>" data-item="default">
            <i class="material-icons-outlined">home</i>
        </a>

        <a href="/admin" class="item <?php if($menu_active == "business"){ echo "active"; } ?>" data-item="default">
            <i class="material-icons-outlined">work_outline</i>
        </a>

        <!-- <a href="/admin" class="item <?php if($menu_active == "tasks"){ echo "active"; } ?>" data-item="default">
            <i class="material-icons-outlined">bookmark_border</i>
        </a> -->

        <a href="/admin" class="item <?php if($menu_active == "crm"){ echo "active"; } ?>" data-item="default">
            <i class="material-icons-outlined">filter_list</i>
        </a>

        <!-- <a href="/admin" class="item <?php if($menu_active == "invoices"){ echo "active"; } ?>" data-item="default">
            <i class="material-icons-outlined">description</i>
        </a> -->

        <a href="/admin" class="item <?php if($menu_active == "permissions"){ echo "active"; } ?>" data-item="default">
            <i class="material-icons-outlined">outlined_flag</i>
        </a>

        <a href="/admin" class="item <?php if($menu_active == "account"){ echo "active"; } ?>" data-item="default">
            <i class="material-icons-outlined">perm_identity</i>
        </a>

        <a href="/admin" class="item <?php if($menu_active == "reports"){ echo "active"; } ?>" data-item="default">
            <i class="material-icons-outlined">class</i>
        </a>

        <a href="/admin" class="item <?php if($menu_active == "indicators"){ echo "active"; } ?>" data-item="default">
            <i class="material-icons-outlined">bookmark_border</i>
        </a>

        <a href="/admin" class="item <?php if($menu_active == "support"){ echo "active"; } ?>" data-item="default">
        ...
        <div class="hidden-mobile visible-xs menu-mobile" style="position: fixed; box-shadow: 0px 10px 20px rgba(0,0,0,.1); z-index: 2;">
            ...
            <div class="box-user-tooltip">
                ...
                <div class="text-center margin-t-30 margin-b-10">
                    <a href="/admin/account" class="btn btn-yellow btn-block size-sm">EDITAR PERFIL</a>
