<div class="modal fade" id="open_document_client" tabindex="-1" role="dialog" aria-labelledby="open_document_clientLabel" aria-hidden="true">
                ...
                <?php $x=0; foreach ($all_documents as $documents) { $x++; ?>
                    ...
                    <div class="text-left item-documents" id="item-documents-<?= $documents->id; ?>" style="display: none;">
                        ...
                        <div class="text-center">
                            ...
                            <?php if($documents->origin == "client"){ ?>
                                <div class="btn btn-line-gray size-lg margin-t-50 btn_send_form"
                                        data-url="/api/web/client/documents/<?= $documents->id; ?>/delete" data-form="#form" data-redirect="none">EXCLUIR DOCUMENTO</div>
                            <?php } ?>
                        </div>
