    ...
    <div class="modal-dialog size-medium" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 style="font-weight: 500; color: #333;">Adicionar conta a pagar</h4>
            </div>
                ...
                <form id="form_add_payment">
                    ...
                    <div class="row margin-t-20">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 animate-scroll">
                            ...
                            <input type="text" class="form-control accountant required" name="payment_title" style="font-size: 14px; background-color: #fff;">

                            <p class="text margin-t-20" style=" margin-bottom: 10px; color: #969696; font-weight: 600;">Valor</p>
                            <input type="text" class="form-control required money2" name="payment_value" style="font-size: 14px; background-color: #fff;">

                            <p class="text margin-t-20" style=" margin-bottom: 10px; color: #969696; font-weight: 600;">Juros</p>
                            <input type="text" class="form-control required money2" name="payment_juros" style="font-size: 14px; background-color: #fff;" value="0">
                            
                            <p class="text margin-t-20" style=" margin-bottom: 10px; color: #969696; font-weight: 600;">Multa</p>
                            <input type="text" class="form-control required money2" name="payment_multa" style="font-size: 14px; background-color: #fff;" value="0">
                            

                            <p class="text margin-t-20" style=" margin-bottom: 10px; color: #969696; font-weight: 600;">Tipo de Pagamento</p>
                            <select type="text" class="form-control required" name="payment_type" style="font-size: 14px; background-color: #fff;" id="input_payment_type">
                            ...
                            <p class="text margin-t-20" id="text_payment_type" style=" margin-bottom: 10px; color: #969696; font-weight: 600;">Nome</p>
                    
                            <select type="text" class="form-control required" name="payment_customer" style="font-size: 14px; background-color: #fff;" id="select_payment_customer">
                            ...
                            <select type="text" class="form-control required" name="payment_provider" style="font-size: 14px; background-color: #fff; display: none;" id="select_payment_provider">
                            ...
                            <select type="text" class="form-control required" name="payment_employee" style="font-size: 14px; background-color: #fff; display: none;" id="select_payment_employee">
                            ...
                            <select type="text" class="form-control required" name="payment_partner" style="font-size: 14px; background-color: #fff; display: none;" id="select_payment_partner">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 animate-scroll">
                            ...
                            <select type="text" class="form-control required" name="payment_account" style="font-size: 14px; background-color: #fff;">
                            ...
                            <select type="text" class="form-control required" name="payment_category_id" style="font-size: 14px; background-color: #fff;">
                            ...
                            <div class="input-date">
                                ...
                                value="<?= $date; ?>" placeholder="" style="cursor: pointer;" id="input_payment_maturity">

                                <!-- Datepicker -->
                                <div class="box-datepicker accountant">
                                    <div class="datepicker" data-date="<?= h($date_input); ?>" data-id="#input_payment_maturity"></div>
                                </div>
                            ...
                            <select type="text" class="form-control required" name="payment_division" style="font-size: 14px; background-color: #fff;" id="input_payment_division">
                            ...
                            <select type="text" class="form-control required" name="payment_recurrent" style="font-size: 14px; background-color: #fff;" id="input_payment_recurrent">
                    ...
                    <div class="btn btn-yellow size-lg margin-t-0 margin-b-10 btn_send_form"
                        data-url="/api/web/custom/payments/add" data-form="#form_add_payment" data-redirect="none">
                            CRIAR PAGAMENTO
                    </div>
