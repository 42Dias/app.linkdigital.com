    ...
    <div class="modal-dialog size-small" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 style="font-weight: 500; color: #333;">Novo comentário</h4>
            </div>
            <div class="modal-body">
                ...
                <form method="POST" id="form_add_activity_accountant" enctype="multipart/form-data">
                    ...
                    <div class="text-center">
                        <div class="btn btn-yellow size-lg margin-t-50 btn_send_form"
                                data-url="/api/web/accountant/activity/add" data-form="#form_add_activity_accountant" data-redirect="none">
                                ADICIONAR
                        </div>
                    </div>
