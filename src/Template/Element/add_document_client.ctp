<div class="modal fade" id="add_document_client" tabindex="-1" role="dialog" aria-labelledby="add_document_clientLabel" aria-hidden="true">
    <div class="modal-dialog size-small" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="form_add_document_client">
                    ...
                    <div  id="area-add-documents">
                        ...
                        <input type="text" class="form-control required" name="description-1" style="font-size: 14px; background-color: #fff;">
                    ...
                    <label class="fileContainer ">
                        ...
                        <button type="button" class="btn btn-default" id="btn-add-document">Adicionar mais documentos +</button>
                    </label>

                    <div class="text-center">
                        <div class="btn btn-yellow size-lg margin-t-50 btn_send_form"
                                data-url="/api/web/client/documents/add" data-form="#form_add_document_client" data-redirect="none">
                                ADICIONAR
                        </div>
                    </div>
