    ...
    <div class="container" style="padding-top: 150px; padding-bottom: 100px;">
        ...
        <div class="row" style="margin-top: 0px;">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center animate-scroll" style="padding-top: 50px;">
                ...
                <a href="/ja-tenho-empresa-produtos" class="btn btn-yellow size-lg margin-t-20">
                    CONTRATAR AGORA
                </a>
            </div>
        </div>
        ...
        <div class="row" style="margin-top: 70px;">
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12 text-center">
                ...
                <div class="btn-slide-home margin-r-20" style="min-height: 250px; font-size: 12px; vertical-align: middle;">

                    <p style="font-size: 12px;">
                        <strong style="font-size: 20px; margin-bottom: 10px; color: #ffce2c;">Comodidade</strong><br/><br/>
            ...
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12 text-center">
                ...
                <div class="btn-slide-home margin-r-20" style="min-height: 250px; font-size: 12px; vertical-align: middle;">
                    ...
                    <p style="font-size: 12px;">
                        <strong style="font-size: 20px; margin-bottom: 10px; color: #ffce2c;">Facilidade</strong><br/><br/>
            ...
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12 text-center">
                ...
                <div class="btn-slide-home margin-r-20" style="min-height: 250px; font-size: 12px; vertical-align: middle;">
                    ...
                    <p style="font-size: 12px;">
                        <strong style="font-size: 20px; margin-bottom: 10px; color: #ffce2c;">Mentoria</strong><br/><br/>
            ...
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12 text-center">
                ...
                <div class="btn-slide-home margin-r-20" style="min-height: 250px; font-size: 12px; vertical-align: middle;">
                    ...
                    <p style="font-size: 12px;">
                        <strong style="font-size: 20px; margin-bottom: 10px; color: #ffce2c;">Consultorias</strong><br/><br/>
