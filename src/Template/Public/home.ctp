...
<!-- Section 1 -->
<section class=""
    style="background-image: url(../img/bg-homepage-v9.jpg); background-repeat: no-repeat; background-size: cover; background-position: right top; height: auto; ">

    <div class="container" style="padding-top: 150px; padding-bottom: 80px;">

        <div class="hidden-mobile visible-lg" style="margin-top: 130px;"></div>

        <div class="row">
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12 text-left animate-scroll">

                <!-- <h3 style="font-size: 20px; color: #fff;">Contabilidade digital</h3> -->

                <span style="font-size: 40px; color: #fff; font-weight: 600; line-height: 46px;">
                    Sua contabilidade digital lucrativa e segura!
                </span>

                <p style="margin-top: 20px; font-size: 16px; color: #9c9c9c;">
                    Venha para a Link e conheça as vantagens para sua empresa
                </p>

                <a href="/fale-conosco" class="btn btn-yellow size-lg">
                    FALAR COM ESPECIALISTA
                </a>

            </div>

            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12 text-left animate-scroll" style="margin-top: 30px;">

                <a href="/solucoes/gestor-financeiro" class="btn-slide-home margin-r-20">
                    <div class="flag" style="background-color: #41ffc7;">GRÁTIS*</div>
                    GESTÃO FINANCEIRA
                    <p style="margin-top: 5px; font-size: 12px; color: #9c9c9c;">
                        Acesso gratuito da plataforma financeira por 15 dias
                    </p>
                </a>

                <a href="abrir-empresa-gratis" class="btn-slide-home" >
                    <div class="flag">GRÁTIS*</div>
                    ABRIR MINHA EMPRESA
                    <p style="margin-top: 5px; font-size: 12px; color: #9c9c9c;">
                ...
                <a href="ja-tenho-empresa" class="btn-slide-home margin-r-20">
                    TRANSFERIR MINHA EMPRESA
                </a>

                <a href="#simular-mensalidade" class="btn-slide-home">
                    SIMULE A MENSALIDADE DA SUA EMPRESA
                </a>

                <!-- <a href="#" data-toggle="modal" data-target="#transferir_mei_me" class="btn-slide-home" style="width: 100%;">
                    <div class="flag">GRÁTIS*</div>
                    TRANSFERIR MEI PARA ME
                </a> -->
